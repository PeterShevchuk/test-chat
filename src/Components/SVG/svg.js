...
const Icons = {
  ...
  Back: ({ size = initialSize, className = "Back", fill = initialFill, ...props }) => (
    <svg className={"svg " + className} fill={fill} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 492 492" width={size} height={size} {...props}>
      <path
